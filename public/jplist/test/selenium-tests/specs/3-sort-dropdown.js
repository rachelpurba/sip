...
describe('sort by likes number asc (top)', function() {
    ...
    it('first item should have 5 Likes', function (done) {
        ...
        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[1]')).toBe('5 Likes');
        browser.call(done);
    });

    it('second item should have 7 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[2]')).toBe('7 Likes');
        browser.call(done);
    });

    it('third item should have 11 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[3]')).toBe('11 Likes');
        browser.call(done);
    });

    it('item #4 should have 12 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[4]')).toBe('12 Likes');
        browser.call(done);
    });

    it('item #5 should have 14 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[5]')).toBe('14 Likes');
        browser.call(done);
    });
...
describe('sort by likes number desc (top)', function() {
    ...
    it('first item should have 321 Likes', function (done) {
        ...
        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[1]')).toBe('321 Likes');
        browser.call(done);
    });

    it('second item should have 191 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[2]')).toBe('191 Likes');
        browser.call(done);
    });

    it('third item should have 128 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[3]')).toBe('128 Likes');
        browser.call(done);
    });

    it('item #4 should have 125 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[4]')).toBe('125 Likes');
        browser.call(done);
    });

    it('item #5 should have 100 Likes', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="like"])[5]')).toBe('100 Likes');
        browser.call(done);
    });
...
describe('sort by date number asc (top)', function() {
    ...
    it('first item should have 03/03/1953', function (done) {
        ...
        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[1]')).toBe('03/03/1953');
        browser.call(done);
    });

    it('second item should have 05/25/1965', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[2]')).toBe('05/25/1965');
        browser.call(done);
    });

    it('third item should have 06/19/1981', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[3]')).toBe('06/19/1981');
        browser.call(done);
    });

    it('item #4 should have 12/31/1986', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[4]')).toBe('12/31/1986');
        browser.call(done);
    });

    it('item #5 should have 03/08/1990', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[5]')).toBe('03/08/1990');
        browser.call(done);
    });
...
describe('sort by date number desc (top)', function() {
    ...
    it('first item should have 07/26/2012', function (done) {
        ...
        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[1]')).toBe('07/26/2012');
        browser.call(done);
    });

    it('second item should have 03/19/2012', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[2]')).toBe('03/19/2012');
        browser.call(done);
    });

    it('third item should have 03/18/2012', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[3]')).toBe('03/18/2012');
        browser.call(done);
    });

    it('item #4 should have 03/15/2012', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[4]')).toBe('03/15/2012');
        browser.call(done);
    });

    it('item #5 should have 01/16/2011', function (done) {

        expect(browser.getText('(//div[@class="list-item box"]//p[@class="date"])[5]')).toBe('01/16/2011');
        browser.call(done);
    });

...
@section('content')
	<h3 style="text-align: center">Daftar Publikasi Jurnal Biofarmaka</h3>
	<div id="demo">
				...
				<div class="jplist-panel">
                    ...
                    <div style="display: inline-block;" class="dropdown" data-control-type="boot-sort-drop-down" data-control-name="bootstrap-sort-dropdown-demo" data-control-action="sort" data-datetime-format="{year}"> 
				        ...
				        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
				         ...
				         <li role="presentation">
						    <a role="menuitem" tabindex="-1" href="#" data-path=".year" data-order="asc" data-type="datetime">Tahun asc</a>
				         </li>
				         <li role="presentation">
						    <a role="menuitem" tabindex="-1" href="#" data-path=".year" data-order="desc" data-type="datetime" data-default="true">Tahun desc</a>
				         </li>
				        </ul>
				    </div>
		    ...
		    <div class="panel-body">
	    		<div class="list">
					...
					<div class="list-item" style="border-bottom: rgb(210, 214, 222) thin solid">
						<h4 class="title"><b>{{$publikasijurnal->judul_artikel}}</b></h4>
						<ul class="list-inline">
							<li class="year">{{$publikasijurnal->tahun_terbit}}</li>
							<li class="status">{{$publikasijurnal->status_akreditasi}}</li>
							<li class="berkala">{{$publikasijurnal->nama_berkala}}</li>
							<li>{{$publikasijurnal->volume_halaman}}</li>
						</ul>
						<ul class="list-inline">
							Peneliti Biofarmaka:

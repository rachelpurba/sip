...
@section('content')
	<h3 style="text-align: center">Daftar Publikasi Buku Biofarmaka</h3>
	<div id="demo">
		    ...
		    <div class="panel-body">
		    	<div class="list">
					...
					<div class="list-item" style="border-bottom: rgb(210, 214, 222) thin solid">
						<h4 class="title"><b>{{$publikasibuku->judul_buku}} Chapter: {{$publikasibuku->judul_book_chapter}}</b></h4>
						<ul class="list-inline">
							<li class="year">{{$publikasibuku->tahun_terbit}}</li>
							<li>{{$publikasibuku->nama_penerbit}}</li>
							<li>{{$publikasibuku->isbn}}</li>
						</ul>
						<ul class="list-inline">
							Peneliti Biofarmaka:
